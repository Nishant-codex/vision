...
def EVNet(
    ...
    k_exc=None, noise_fano=None, noise_scale=1, noise_level=0, ksize=31, stride=2, set_gabor_orientation=None,
    gabor_color_prob=None, noise_mode=None
    ):
    ...
    if with_voneblock:
        ...
        k_exc = get_v1_k_exc(with_retinablock=with_retinablock, gabor_color_prob=gabor_color_prob)  if k_exc is None else k_exc
