...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch20']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch20'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_19.pth",
                          version_id="HSkHKM299.jjeSlc2l9Ij3rluIhTehO7",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch20', model=model, preprocessing=preprocessing)
