...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed4']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed4'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed4', model=model, preprocessing=preprocessing)
