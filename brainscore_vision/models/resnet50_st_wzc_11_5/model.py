...
def get_model_list():
    return ['resnet50_st_wzc_11_5']

def get_model(name):
    assert name == 'resnet50_st_wzc_11_5'
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_st_wzc_checkpoint_89_11.5.pth",
                          version_id="E3hkpacQioqQ9Qnwbi9RvMKGsv6n.ouc",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_11_5', model=model, preprocessing=preprocessing)
