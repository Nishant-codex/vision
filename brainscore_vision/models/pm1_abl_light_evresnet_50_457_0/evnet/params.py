...
P_cell_params = { # Carandini contrast
    'radius_la': np.inf,
    'kernel_la': 1,
    'rc_dog': 1.494800846305186,
    'rs_dog': 7.152799999999999,
    'kernel_dog': 19,
    'ratio_dog': -0.011894632845946745,
    'radius_cn': 13.411499999999998,
    'kernel_cn': 33,
    'c50_cn': 1.0,
    'exp_cn': 1.0,
    'k_exc': 5.29525198895458
    }
...
M_cell_params = {
    ...
    'kernel_la': 1,
    'rc_dog': 2.4203904,
    'rs_dog': 17.091879253424104,
    'kernel_dog': 43,
    'ratio_dog': -0.0037506100912582663,
    'radius_cn': 28.872192000000002,
    'kernel_cn': 69,
    'c50_cn': 0.18501829502844522,
    'exp_cn': 0.8068704487883759,
    'k_exc': 2.8494928592250206
 }
...
def get_tuned_params(
    ...
    kernel_la = np.array([get_kernel_size(r, energy=energy) for r in radius_la.tolist()], dtype=np.int16)
