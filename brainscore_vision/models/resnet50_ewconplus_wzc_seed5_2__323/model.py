...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed5_2__323']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed5_2__323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_ewconplus_wzc_seed5_checkpoint_89.pth",
                          version_id="s7jyFUfmgk1Rr0yKpq0qGw_0D3cV12qC",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed5_2__323', model=model, preprocessing=preprocessing)
