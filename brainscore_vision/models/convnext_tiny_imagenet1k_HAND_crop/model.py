...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_HAND_crop'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_HAND_crop/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_HAND_crop', model=model, preprocessing=preprocessing)
