...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_APGD_HANDmean'
    fileName='ConvNeXt-tiny_ImageNet_None_APGDLinf-2_None_HAND_Conv_LayerNorm_StridedConv_CELoss_None'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_APGD_HANDmean/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_APGD_HANDmean', model=model, preprocessing=preprocessing)
