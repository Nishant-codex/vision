...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch40']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch40'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_39.pth",
                          version_id="exW.FMiLGlmkT3cUUqWESiKzWPg0YHh7",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch40', model=model, preprocessing=preprocessing)
