...
def get_model_list():
    return ['resnet50_ew_no_wzc_seed5']

def get_model(name):
    assert name == 'resnet50_ew_no_wzc_seed5'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                      relative_path="hvs_c_no_seed5_checkpoint_89.pth",
                      version_id="8ao4u722t1nxlDGoh6rUELRLCxQDOCku",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ew_no_wzc_seed5', model=model, preprocessing=preprocessing)
