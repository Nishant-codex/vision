...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch70']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch70'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_69.pth",
                          version_id="5yPta1TkW5r4htO78nTVM4Wgb_K2GNAD",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch70', model=model, preprocessing=preprocessing)
