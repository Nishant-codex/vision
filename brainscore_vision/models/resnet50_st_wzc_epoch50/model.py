...
def get_model_list():
    return ['resnet50_st_wzc_epoch50']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch50'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_49.pth",
                          version_id="n26VeCENSF6CTplFj2zl5OZdgUwHW2Aq",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch50', model=model, preprocessing=preprocessing)
