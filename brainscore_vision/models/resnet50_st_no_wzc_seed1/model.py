...
def get_model_list():
    return ['resnet50_st_no_wzc_seed1']

def get_model(name):
    assert name == 'resnet50_st_no_wzc_seed1'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                      relative_path="st_no_seed1_checkpoint_89.pth",
                      version_id="mJ8pdEtFp1Z7x8R3fu2_NQnrPPCx.cqj",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_no_wzc_seed1', model=model, preprocessing=preprocessing)
