...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch30']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch30'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_29.pth",
                          version_id="rj44TYfEEsVF8nm6wVjpMYPbSGqihjPG",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch30', model=model, preprocessing=preprocessing)
