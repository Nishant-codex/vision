...
def get_model_list():
    return ['resnet50_st_wzc_seed5']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed5'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed5', model=model, preprocessing=preprocessing)
