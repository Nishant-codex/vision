...
def get_model_list():
    return ['resnet50_ew_no_wzc_seed2']

def get_model(name):
    assert name == 'resnet50_ew_no_wzc_seed2'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                      relative_path="hvs_c_no_seed2_checkpoint_89.pth",
                      version_id="p5g9PHkUB3_cgAQ8VkTYiNOEu2qCKsC6",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ew_no_wzc_seed2', model=model, preprocessing=preprocessing)
