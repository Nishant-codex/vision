...
def get_model_list():
    return ['resnet50_ew_no_wzc']

def get_model(name):
    assert name == 'resnet50_ew_no_wzc'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="hvs_c_no_checkpoint_89.pth",
                          version_id="UpNUPCP46m9vyuJY_2T2ck4RyT2ATS0F",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ew_no_wzc', model=model, preprocessing=preprocessing)
