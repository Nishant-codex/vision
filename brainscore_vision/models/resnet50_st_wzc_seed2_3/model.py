...
def get_model_list():
    return ['resnet50_st_wzc_seed2_3']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed2_3'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed2_3', model=model, preprocessing=preprocessing)
