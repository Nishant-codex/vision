...
def get_model_list():
    return ['resnet50_ewconplus_noseed_2_323']

def get_model(name):
    assert name == 'resnet50_ewconplus_noseed_2_323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_ewconplus_noseed2_checkpoint_89.pth",
                          version_id="xmakGXoO5ZgnDq337HeGw0mMC7O590M7",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_noseed_2_323', model=model, preprocessing=preprocessing)
