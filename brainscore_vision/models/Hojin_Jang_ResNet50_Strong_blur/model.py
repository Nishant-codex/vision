...
def get_model_list():
    return ['Hojin_Jang_ResNet50_Strong_blur']

def get_model(name):
    assert name == 'Hojin_Jang_ResNet50_Strong_blur'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                      relative_path="ResNet50_Strong-blur.pth",
                      version_id="P.jcOdGttaD06a1tIIA7EEb0AziJX3IX",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='Hojin_Jang_ResNet50_Strong_blur', model=model, preprocessing=preprocessing)
