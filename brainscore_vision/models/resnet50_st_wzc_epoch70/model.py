...
def get_model_list():
    return ['resnet50_st_wzc_epoch70']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch70'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_69.pth",
                          version_id="ln8RxBl6.g6gcB5yAAgWFmkJyLRj2Tuk",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch70', model=model, preprocessing=preprocessing)
