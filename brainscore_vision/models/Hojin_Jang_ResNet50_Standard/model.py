...
def get_model_list():
    return ['Hojin_Jang_ResNet50_Standard']

def get_model(name):
    assert name == 'Hojin_Jang_ResNet50_Standard'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="ResNet50_Standard.pth",
                          version_id="KUGkZvmKdDTJfo6t7ysfGCkZp5wRZgPk",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='Hojin_Jang_ResNet50_Standard', model=model, preprocessing=preprocessing)
