...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed5_2_']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed5_2_'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed5_2_', model=model, preprocessing=preprocessing)
