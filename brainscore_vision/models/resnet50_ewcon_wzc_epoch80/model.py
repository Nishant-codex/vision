...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch80']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch80'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_79.pth",
                          version_id="C7NA7Hk4VJ7t7YgO0bSVjKwRu6wba4pO",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch80', model=model, preprocessing=preprocessing)
