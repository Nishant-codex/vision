...
def get_model_list():
    return ['resnet50_ewconplus_wzc_2_323']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_2_323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_ewcon+_wzc_checkpoint_89.pth",
                          version_id="6xLFmPsjMoi8do8RwEmslI4knz13UL_g",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_2_323', model=model, preprocessing=preprocessing)
