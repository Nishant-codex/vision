...
def get_model_list():
    return ['resnet50_st_wzc_seed5_2_323']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed5_2_323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_st_wzc_seed5_checkpoint_89.pth",
                          version_id="wNH9ObV4T1lh6OHqxAxo7Dfe_WkliSMr",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed5_2_323', model=model, preprocessing=preprocessing)
