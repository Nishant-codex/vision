...
def get_model_list():
    return ['resnet50_ew_no_wzc_seed3']

def get_model(name):
    assert name == 'resnet50_ew_no_wzc_seed3'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                      relative_path="hvs_c_no_seed3_checkpoint_89.pth",
                      version_id="douBPtxvCO1ka6eQuhoY9ZAz36X2zahi",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ew_no_wzc_seed3', model=model, preprocessing=preprocessing)
