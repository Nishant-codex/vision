...
def get_model_list():
    return ['resnet50_st_no_wzc_seed2']

def get_model(name):
    assert name == 'resnet50_st_no_wzc_seed2'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                      relative_path="st_no_seed2_checkpoint_89.pth",
                      version_id="MB58k958P_gxkvU6R9rP0B9q0LWqUCQn",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_no_wzc_seed2', model=model, preprocessing=preprocessing)
