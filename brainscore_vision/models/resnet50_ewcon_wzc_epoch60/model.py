...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch60']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch60'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_59.pth",
                          version_id="_WRBjR.hEG6oRHRY5TRMY3BrasvL1SDV",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch60', model=model, preprocessing=preprocessing)
