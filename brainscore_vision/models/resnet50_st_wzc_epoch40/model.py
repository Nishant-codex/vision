...
def get_model_list():
    return ['resnet50_st_wzc_epoch40']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch40'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_39.pth",
                          version_id="fWRZ9OvNrEuctyzHe.25lD8b12L7Q.wd",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch40', model=model, preprocessing=preprocessing)
