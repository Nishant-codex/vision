...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_HAND'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_HAND/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_HAND', model=model, preprocessing=preprocessing)
