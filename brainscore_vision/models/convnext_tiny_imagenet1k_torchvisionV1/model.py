...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1K_torchvisionV1'
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1K_torchvisionV1', model=model, preprocessing=preprocessing)
