...
def get_model_list():
    return ['resnet50_st_no_wzc_seed4']

def get_model(name):
    assert name == 'resnet50_st_no_wzc_seed4'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                      relative_path="st_no_seed4_checkpoint_89.pth",
                      version_id="u6V5fVHnCj7SC62aKGiDIldjW4lxkVQD",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_no_wzc_seed4', model=model, preprocessing=preprocessing)
