...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_HAND_PS'
    fileName='ConvNeXt-tiny_ImageNet_None_None_None_HAND_Conv_IdentityNorm_MaxPool_CELoss_None'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_HAND_PS/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_HAND_PS', model=model, preprocessing=preprocessing)
