...
def get_model_list():
    return ['resnet50_ew_no_wzc_seed1']

def get_model(name):
    assert name == 'resnet50_ew_no_wzc_seed1'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                      relative_path="hvs_c_no_seed1_checkpoint_89.pth",
                      version_id="n6P0UXmBMRYw8hyl5yhyT3bLvnsYddPk",
                      ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ew_no_wzc_seed1', model=model, preprocessing=preprocessing)
