...
def get_model_list():
    return ['resnet50_st_wzc_epoch30']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch30'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_29.pth",
                          version_id="N.c_tr8DxnGCusoTO_9dLkTAWmR7DqrD",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch30', model=model, preprocessing=preprocessing)
