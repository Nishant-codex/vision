...
def get_model_list():
    return ['resnet50_ewcon_wzc_epoch50']

def get_model(name):
    assert name == 'resnet50_ewcon_wzc_epoch50'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="ew_checkpoint_49.pth",
                          version_id="WTpWEPvicpRzMVBGsPzn5ebna9R7PL3W",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewcon_wzc_epoch50', model=model, preprocessing=preprocessing)
