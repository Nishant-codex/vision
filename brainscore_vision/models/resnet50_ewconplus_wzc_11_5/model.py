...
def get_model_list():
    return ['resnet50_ewconplus_wzc_11_5']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_11_5'
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_ewcon+_wzc_checkpoint_89_11.5.pth",
                          version_id="YPCt.c5Nr.Ezl0vgYeeD7imIwo4s1Ilm",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_11_5', model=model, preprocessing=preprocessing)
