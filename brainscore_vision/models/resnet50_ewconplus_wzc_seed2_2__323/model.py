...
def get_model_list():
    return ['resnet50_ewconplus_wzc_seed2_2__323']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc_seed2_2__323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_ewconplus_wzc_seed2_checkpoint_89.pth",
                          version_id="Ub_uDIMDna0x0ZQ9pnTX9aMEuydn.LQt",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc_seed2_2__323', model=model, preprocessing=preprocessing)
