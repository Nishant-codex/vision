...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_HANDsum'
    fileName='ConvNeXt-tiny_ImageNet_None_None_None_HAND_Conv_LayerNorm_StridedConv_CELoss_None'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_HANDsum/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_HANDsum', model=model, preprocessing=preprocessing)
