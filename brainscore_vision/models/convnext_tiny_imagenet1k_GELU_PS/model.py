...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_GELU_PS'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_GELU_PS/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_GELU_PS', model=model, preprocessing=preprocessing)
