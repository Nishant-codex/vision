...
def get_model_list():
    return ['resnet50_ewconplus_wzc']

def get_model(name):
    assert name == 'resnet50_ewconplus_wzc'
    ...
    wrapper = PytorchWrapper(identifier='resnet50_ewconplus_wzc', model=model, preprocessing=preprocessing)
