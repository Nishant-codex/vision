...
def get_model_list():
    return ['resnet50_st_wzc_epoch80']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch80'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_79.pth",
                          version_id="s.cwtLsjuLg4XpB8GUhAxy6IzwXBjfsF",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch80', model=model, preprocessing=preprocessing)
