...
def get_model_list():
    return ['resnet50_st_wzc_seed4_2_323']

def get_model(name):
    assert name == 'resnet50_st_wzc_seed4_2_323'

    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_672/",
                          relative_path="resnet50_st_wzc_seed4_checkpoint_89.pth",
                          version_id="PqYmnJs5Gk55RS5qU8Q_HxF2G48OE0ea",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_seed4_2_323', model=model, preprocessing=preprocessing)
