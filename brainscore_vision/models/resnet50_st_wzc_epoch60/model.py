...
def get_model_list():
    return ['resnet50_st_wzc_epoch60']

def get_model(name):
    assert name == 'resnet50_st_wzc_epoch60'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="checkpoint_59.pth",
                          version_id="5apxftKReCSmS03YxTrYL8gegQ8e0vNy",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_wzc_epoch60', model=model, preprocessing=preprocessing)
