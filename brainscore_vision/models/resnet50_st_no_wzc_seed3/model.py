...
def get_model_list():
    return ['resnet50_st_no_wzc_seed3']

def get_model(name):
    assert name == 'resnet50_st_no_wzc_seed3'
    ...
    file_path = load_file(bucket="brainscore-storage", folder_name="brainscore-vision/models/user_755/",
                          relative_path="st_no_seed3_checkpoint_89.pth",
                          version_id="b3I.wdIHQxX0ZHocKT6quveCpRoO4Au1",
                          ),
    ...
    wrapper = PytorchWrapper(identifier='resnet50_st_no_wzc_seed3', model=model, preprocessing=preprocessing)
