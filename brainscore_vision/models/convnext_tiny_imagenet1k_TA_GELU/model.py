...
def get_model(name):
    assert name == 'convnext_tiny_imagenet1k_TA_GELU'
    fileName='ConvNeXt-tiny_ImageNet_None_TrivialAug+RandErase0.1+mixup_None_GELU_Conv_LayerNorm_StridedConv_CELoss_None'
    ...
    #model = import_weights('brainscore_vision/models/convnext_tiny_imagenet1k_TA_GELU/'+fileName+'.pt', model, device)
    ...
    wrapper = PytorchWrapper(identifier='convnext_tiny_imagenet1k_TA_GELU', model=model, preprocessing=preprocessing)
